...
export function CardIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M7 7h2M15 7h2M7 12h10M7 16h6" />
    </svg>
  );
}
...
export function BotIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      ...
      <circle cx="8.5" cy="15" r="1.5" fill="currentColor" strokeWidth={0} />
      <circle cx="15.5" cy="15" r="1.5" fill="currentColor" strokeWidth={0} />
      <path d="M9 19h6" />
    </svg>
  );
}
...
export function StarIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" stroke="none">
      <path d="M12 2l2.9 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l7.11-1.01L12 2z" />
    </svg>
  );
}
...
export function DiceIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      ...
      <circle cx="7" cy="7" r="1.2" fill="currentColor" strokeWidth={0} />
      <circle cx="17" cy="7" r="1.2" fill="currentColor" strokeWidth={0} />
      <circle cx="12" cy="12" r="1.2" fill="currentColor" strokeWidth={0} />
      <circle cx="7" cy="17" r="1.2" fill="currentColor" strokeWidth={0} />
      <circle cx="17" cy="17" r="1.2" fill="currentColor" strokeWidth={0} />
    </svg>
  );
}
...
export function KickIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      <path d="M17 16l4-4-4-4M7 8l-4 4 4 4" />
      <path d="M3 12h14" />
    </svg>
  );
}
...
export function HammerIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M20.35 6.22l-2.07-2.07a1.5 1.5 0 00-2.12 0L14 6.29l3.71 3.71 2.64-2.64a1.5 1.5 0 000-2.14z" />
    </svg>
  );
}
...
export function CrownIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 20h20M5 20L3 8l4.5 4.5L12 4l4.5 8.5L21 8l-2 12H5z" />
    </svg>
  );
}
...
export function MemberIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
export function LogoIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none">
      <path d="M16 3L28 10v12L16 29 4 22V10L16 3z" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M16 9l7 4v7l-7 4-7-4v-7l7-4z" fill="currentColor" fillOpacity={0.3} stroke="currentColor" strokeWidth={1} />
      <circle cx="16" cy="16" r="2.5" fill="currentColor" />
    </svg>
  );
}

export function LoadingSpinner({ className = "w-8 h-8" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round">
      <circle cx="12" cy="12" r="10" strokeOpacity={0.25} />
      <path d="M12 2a10 10 0 0110 10" className="animate-spin origin-center" style={{ animationDuration: '0.8s' }} />
    </svg>
  );
}

// Inline status message component
export function StatusMsg({ msg, className = "" }: { msg: string; className?: string }) {
  if (!msg) return null;
  const isOk = msg.startsWith('ok:') || /sucesso|[Ss]alvo|salv[ao]s?|criado|atualizado|Perfil/i.test(msg);
  return (
    <div className={`flex items-center gap-2 text-sm font-bold px-3 py-2 rounded-xl border ${isOk ? 'text-green-400 bg-green-500/10 border-green-500/30' : 'text-red-400 bg-red-500/10 border-red-500/30'} ${className}`}>
      {isOk ? <CheckCircleIcon className="w-4 h-4 shrink-0" /> : <XCircleIcon className="w-4 h-4 shrink-0" />}
      <span>{msg.replace(/^(ok:|err:)/, '').replace(/^[✅❌]\s*/, '')}</span>
    </div>
  );
}
