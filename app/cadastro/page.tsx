                ...
                <div className="absolute top-full mt-2 w-80 bg-gray-900 border border-gray-700 rounded-xl shadow-2xl z-50 p-6">
                  ...
                  <div className="grid grid-cols-7 gap-2 mb-4">
                    {['Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sáb'].map(dia => (
                      <div key={dia} className="text-center text-sm text-gray-400 font-bold py-2">
                        {dia}
                      </div>
                    ))}
                  </div>
                    ...
                    {gerarDiasCalendario().map((dia, index) => (
                      <button
                        ...
                        className={`text-center py-3 px-2 text-sm rounded-lg transition-all ${
                          dia
                            ? 'text-white hover:bg-fuchsia-600 hover:text-white disabled:opacity-50 hover:scale-105'
                            : ''
                        } ${
